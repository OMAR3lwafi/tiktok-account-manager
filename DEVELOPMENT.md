...
```bash
git remote add encore encore://tiktok-account-manager-c3yi
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/tiktok-account-manager-c3yi/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/tiktok-account-manager-c3yi/settings/integrations/github)
